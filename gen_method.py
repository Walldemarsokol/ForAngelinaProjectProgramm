...
def gen_method(argument):
    ...
    while i < l:  # делаем пока не исчерпаем все варианты
        ...
        if F in Y:  # если "пар" есть в списке Y
            ...
            #print(f'>>>>>>>>>>>>>>>>>>> {F}')  # печатаем F, можно распечатать и пронумеровать элементы списка Y
            print(Y)
